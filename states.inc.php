...
$machinestates = [
    ...
    $playerTurn => [
        ...
        'descriptionmyturn' => clienttranslate('${actionCount} actions left'),
        'type' => 'activeplayer',
        'args' => 'argPlayerState',
    ...
    $crewMovement => [
        ...
        'type' => 'multipleactiveplayer',
        'args' => 'argSelectionState',
        'possibleactions' => ['actMoveCrew', 'actCancel', 'actBack'],
        'transitions' => ['playerTurn' => $playerTurn, 'changeZombiePlayer' => $changeZombiePlayer],
    ],
    $characterMovement => [
        ...
        'type' => 'activeplayer',
        'args' => 'argSelectionState',
        'possibleactions' => ['actMoveSelection', 'actBack'],
        'transitions' => ['playerTurn' => $playerTurn, 'changeZombiePlayer' => $changeZombiePlayer],
    ],
    $itemSelection => [
        'name' => 'itemSelection',
    ...
    $battleSelection => [
        ...
        'possibleactions' => ['actBattleSelection', 'actMakeThemFlee', 'actUndo'],
        'transitions' => [
            'endGame' => $gameEnd,
            'changeZombiePlayer' => $changeZombiePlayer,
            'battle' => $battle,
