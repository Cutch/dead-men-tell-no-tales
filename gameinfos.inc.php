...
$gameinfos = [
    ...
    'publisher_website' => 'https://renegadegamestudios.com/',

    // Board Game Geek ID of the publisher
    'publisher_bgg_id' => 150,

    // Board game geek ID of the game
    'bgg_id' => 141423,

    // Players configuration that can be played (1 to 5 players)
    'players' => [1, 2, 3, 4, 5],
    ...
    //
    // Example: 'tie_breaker_description' => _( "Number of remaining cards in hand" ),
    ...
    'player_colors' => ['89357d', '282b2d', 'cd402a', '8a8a8a', '4a9746', 'dd8127', '008cb9'],
